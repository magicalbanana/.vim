...
Shortcut browse working directory
      \ nnoremap <silent> <Space>Od :VimFilerCurrentDir -quit<Return>

Shortcut browse buffer's directory
      \ nnoremap <silent> <Space>od :VimFilerBufferDir -quit<Return>
